...
|---|---|---|---|
| UI | 병합·배포 완료 | PR #55 merge commit `e5516a2`에 결과 화면과 테스트 컨트롤을 제외한 공통·일반 플레이 UI 이미지 교체 및 Web Release를 반영. UI 전용·테스트 환경 검증과 공개 Pages 초기·옵션 화면, 콘솔 오류 없음 확인 | 공개 플레이에서 상점 호버·구매·낮/밤 전환 체감 확인 |
...
| 타워 그래픽·에셋 정리 | UI 에셋 적용·배포 완료 | PR #53 merge commit `ed64e47`의 UI PNG 14개를 PR #55에서 공통·일반 플레이 UI와 Web Release에 적용. 포탑 도트 FX 코드는 아직 미적용 | 포탑 FX 실제 연출 적용 시 에셋 참조와 전투 성능 확인 |
...
| Pages 배포 | 완료 | PR #55 병합 SHA `e5516a2`의 실행 `31195967937` 성공. 공개 HTML의 `index-e5516a260d21.pck` 참조, 17,496,832-byte PCK와 로컬·원격 SHA-256 `0CFA6BED1050067B373435CE010E6A73E67A3F420E55CC8DDABCD0376E052E0B` 일치 및 공개 브라우저 오류 없음 확인 | 다음 기능 병합 후 Web Release 갱신 여부 재확인 |

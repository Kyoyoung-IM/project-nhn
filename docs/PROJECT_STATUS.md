...
| 설치 드롭 판정 | 로컬 구현·Web 검증 완료 | 상점 카드 설치와 설치 타워 이동·머지의 슬롯 중심 드롭 반경을 `70px`에서 `120px`로 확대. 슬롯 간격 `240px`의 절반으로 제한해 이웃 판정 중첩을 방지하고 전용 검사·Web 경계 안 설치·이동·콘솔 확인 완료 | 공개 플레이에서 확대된 드롭 조작감 체감 확인 |

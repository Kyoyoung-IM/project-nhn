...
- 마지막 갱신: 2026-08-08 20:37 KST
- 기준 저장소: `C:\GameDev\GameProject\project-nhn`
- 기준 원격 브랜치: `origin/main`
- 확인된 기준 커밋: `36d9fa0` (`일시정지 전체 화면 딤드 병합`)
...
| 일시정지 딤드 | `main` 병합 | merge commit `36d9fa0`에서 둥근 투명 모서리가 있던 이미지 딤드를 전체 화면 앵커의 50.2% 검정 `ColorRect`로 교체. UI 전용 검사와 병합 후 Web Release 내보내기 통과 | 다음 Pages 배포 후 공개 화면의 네 모서리 딤드 확인 |
